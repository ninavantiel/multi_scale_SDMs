...
class PatchProvider(object):
    ...
    def __getitem__(self, item):
        # print(f"PatchProvider __getitem__ item={item}")
        pass
    
    def __repr__(self):
        # print("PatchProvider __repr__")
        return self.__str__()
    
    @abstractmethod
    def __str__(self):
        # print("PatchProvider __str__")
        pass
    
    def __len__(self):
        # print("PatchProvider __len__")
...
class MetaPatchProvider(PatchProvider):
    def __init__(self, providers, transform=None):
        #print("MetaPatchProvider __init__")
    ...
    def __getitem__(self, item):
        #print(f"MetaPatchProvider __getitem__ item={item}")
    ...
    def __str__(self):
        #print("MetaPatchProvider __str__")
        result = 'Providers:\n'
...
class RasterPatchProvider(PatchProvider):
    def __init__(self, raster_path, size=128, spatial_noise=0, normalize=True, fill_zero_if_error=False, nan_value=0):
        #print("RasterPatchProvider __init__")
...
class MultipleRasterPatchProvider(PatchProvider):
    ...
    def __getitem__(self, item):
        # print(f"MultipleRasterPatchProvider __getitem__ item={item}")
        return np.concatenate([raster[item] for raster in self.rasters_providers])
    
    def __str__(self):
        # print("MultipleRasterPatchProvider __str__")
