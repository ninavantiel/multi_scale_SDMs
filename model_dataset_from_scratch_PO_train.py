...
run_name = '24_dataset_from_scratch_PO_train'
...
if __name__ == "__main__":
    ...
    train_dataset = RGNIR_env_Dataset(presence_only_df, env_patch_size=10, rgbnir_patch_size=100)
    ...
    val_dataset = RGNIR_env_Dataset(presence_absence_df, species=train_dataset.species, env_patch_size=10, rgbnir_patch_size=100)
